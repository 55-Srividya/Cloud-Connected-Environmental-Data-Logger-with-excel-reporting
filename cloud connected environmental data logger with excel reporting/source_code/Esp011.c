...

{
		...
		if(field==1)
		{
			string_uart("GET /update?api_key=P61M7UKAWZUVPXZZ&field1=");
			cmd_lcd(0x01);
			cmd_lcd(0x80);
		...
		{
	string_uart("GET /update?api_key=P61M7UKAWZUVPXZZ&field2=");//LUCKY API KEY
		cmd_lcd(0x01);
		...
		{
	string_uart("GET /update?api_key=P61M7UKAWZUVPXZZ&field3=");
				  	  cmd_lcd(0x01);
             cmd_lcd(0x80);
